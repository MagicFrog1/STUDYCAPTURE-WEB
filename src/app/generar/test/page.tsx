...
export default function QuizPage() {
  ...
  const canSubmit = useMemo(() => files.length > 0 && files.length <= 20 && !loading, [files.length, loading]);
                      ...
                      {files.map((f, i) => {
                        ...
                        return (
                          <div key={i} className="group relative rounded-xl overflow-hidden border border-purple-200 hover:shadow-lg transition-all card-smooth">
                            {isPdf ? (
                              <div className="h-32 w-full bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center">
